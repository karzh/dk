...
local _GANJI_PC = {}
local VERIFY_PAGE_URL_WAP="http://wap.example.com/sorry/confirm.php"
local VERIFY_PAGE_URL_WEB="http://www.example.com/sorry/confirm.php"
