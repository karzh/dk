...
--   local ok, err = memc:connect("127_x.0_x.0_x.0_x", 11211)
--   if not ok then
...
--
-- 注入 example.com/ 的_gj_txz的cookie
--
function dk_txz_install()
  ...
  ngx.header['Set-Cookie'] = {"_gj_txz=" .. txz .. "; expires=" .. ngx.cookie_time(dt) .. "; path=/; domain=example.com"}
  return txz
end
